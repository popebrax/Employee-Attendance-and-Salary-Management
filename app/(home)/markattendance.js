...
//this code is to fetch employee data, and mark attendance then post it to our mongodb using the api link and axios, we also need to view the current attendace statuus of the employees selected
const markattendance = () => {
  ...
  //basically styles the tabs and text etc. to make it visually presentable to the user
  return (
